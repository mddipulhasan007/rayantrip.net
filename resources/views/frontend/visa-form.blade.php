<form method="post" action="{{ route('postStepvisa1') }}">
    ...
    <ul class="one-round-sec mb-60px">
            ...
            <select class="form-control countries-select" id="countries" name="country" placeholder="Enter Country">   
                <option value="" data-capital="" selected>Enter Country</option>
            ...
            <select class="form-control countries-select" id="countries_nat" name="nationality">    
                ...
                <option value="BD" data-capital="Dhaka" selected>Bangladesh</option>
